...
public class AgruparOrcamentoPorGenero {
    public static void main(String[] args) throws IOException, Exception {
       ...
       FileInputFormat.addInputPath(job, input);
        ...
        public static class AgruparOrcamentoPorGeneroReducer extends Reducer<Text, LongWritable, Text, Text> {
            public void reduce(Text key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
                ...
                String valorFormatado = String.valueOf(somaOrcamento);
                context.write(key, new Text(valorFormatado));
